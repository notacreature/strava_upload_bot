TEXT = {
    ...
    "key_run": "👟 Run",
    "key_swim": "🏊‍♀️ Swim",
    "reply_activityupdated": "🤖 Тренировка обновлена!\n```\nИмя: {}\nТип: {}\nЭкипировка: {}\nВремя: {}\nДистанция: {}\nОписание: {}```",
    "reply_activityuploaded": "🤖 Тренировка опубликована!\n```\nИмя: {}\nТип: {}\nЭкипировка: {}\nВремя: {}\nДистанция: {}\nОписание: {}```",
    "reply_activityview": "```\nИмя: {}\nТип: {}\nЭкипировка: {}\nВремя: {}\nДистанция: {}\nОписание: {}```",
    "reply_authorized": "🤖 Отлично! Я получил твое разрешение и готов работать. Просто пришли мне файл в формате `.gpx` или `.tcx` и я его опубликую.",
    ...
    "reply_help": "*Старт*\nДля начала работы с ботом введи команду /start, перейди по ссылке и разреши боту загружать твои тренировки в Strava. Для этого может потребоваться VPN.\n\n*Загрузка*\nОтправь в чат файл в формате `.gpx` или `.tcx` и бот его опубликует. После публикации ты получишь краткую информацию о тренировке и сможешь изменить её Имя, Описание, Тип и Экипировку.\nЕсли передумал, используй /cancel.\n\n*Избранные названия*\nТы можешь запомнить до трёх названий, которые часто используешь – введи команду /favorites и перечисли их через запятую.\n\n*Удаление данных*\nЕсли ты больше не хочешь, чтобы бот загружал файлы в твой аккаунт Strava – используй команду /delete и бот удалит все данные о тебе.",
    "reply_listview": "🤖 Твои последние тренировки:",
    ...
    "reply_start": "🤖 Привет! Я бот, который поможет тебе публиковать твои тренировки в Strava. Для этого мне нужно получить твое разрешение на загрузку файлов в твой аккаунт. Нажми кнопку ниже, чтобы продолжить.",
